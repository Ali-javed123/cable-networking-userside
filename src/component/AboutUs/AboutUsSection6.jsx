  ...
  <div className="container">
    <div className="row align-items-center">
      <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 wow fadeInLeft animated" data-wow-duration="1500ms" data-wow-delay="200ms">
        {/* about-five-info */}
        <div className="about-five-info">
          {/* section-title */}
          <div className="section-title">
            <i className="icon-main-icon" />
            <span>How to Benefit</span>
          </div>
          {/* section-main-title */}
          ...
          {/* about-five-details */}
          <ul className="about-five-details">
            <li className="text">
      ...
      <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 wow fadeInRight animated" data-wow-duration="1500ms" data-wow-delay="200ms">
        {/* about-five-img */}
        <div className="about-five-img">
          <img src="assets/images/shapes/about-three-shape-img-3.png" alt="about-three-shape-img-3" />
          <div className="about-five-img-2" />
          <div className="about-five-img-3" />
          <div className="about-five-img-4" />
          <div className="about-five-img-5" />
          <div className="about-five-img-6" />
        </div>
      </div>
    </div>
  </div>
